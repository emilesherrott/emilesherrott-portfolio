      ...
      <div className="container">
        <div className="d-flex flex-column flex-lg-row align-items-start">
          ...
          <div className="scss-aboutme-text">
            <p>Hello! My name is Emile and I&#39;m a Junior Developer. I used to work for different charities, education and youth organisations. My journey into code has been slow and steady, building up my knowledge, confidence and the finances to make a career change. I&#39;ve recently finished a Software Engineering course which now signals the beginning of my search for a new career and a new chapter of learning.</p>
            <p className="scss-aboutme-last-text">I love cycling, hiking, cooking... and of course coding.</p>
          </div>
