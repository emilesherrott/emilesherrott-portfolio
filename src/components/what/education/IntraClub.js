...
const IntraClub = () => {
  ...
  return (
    <article className="scss-what-article scss-what-education-article">
      <h4>Software Developer Accelerator Programme</h4>
      ...
      <p>Technical masterclasses by industry experts (DevOps, Security, AI) and mentorship by the developers at American Express.</p>
    </article>
  )
}
